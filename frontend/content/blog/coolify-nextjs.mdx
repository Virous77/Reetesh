...
<Callout emoji="💡" isRegular={true}>
  There are many strict security groups and firewall rules that you can setup to
  secure your EC2 instance. Here for sake of simplicity, I have not set up any
  security groups. You can always check official docs.
</Callout>
