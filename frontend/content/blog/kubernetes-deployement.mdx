...
We are using same app which we have dockerized in our pervious article for development.

#### Creating a Dockerfile for Frontend

Rename the existing Dockerfile to **Dockerfile.dev** and Create a new file called **Dockerfile** in the frontend directory and add the following code to it.
...
Make sure you are in the root directory of the project. out of frontend and backend directory.
